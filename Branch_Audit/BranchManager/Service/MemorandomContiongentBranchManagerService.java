...
import com.afr.fms.Branch_Audit.BranchManager.Mapper.MemorandomBranchManagerMapper;
import com.afr.fms.Branch_Audit.Entity.BranchFinancialAudit;

@Service
public class MemorandomContiongentBranchManagerService {

    @Autowired
    private MemorandomBranchManagerMapper memorandomBranchManagerMapper;

    public List<BranchFinancialAudit> getPendingAudits(Long branch_id) {
        return memorandomBranchManagerMapper.getPendingAudits(branch_id);
    }

    public List<BranchFinancialAudit> getRectifiedAudits(Long auditee_id) {
        return memorandomBranchManagerMapper.getRectifiedAudits(auditee_id);
    }

    public List<BranchFinancialAudit> getRespondedAudits(Long auditee_id) {
        return memorandomBranchManagerMapper.getRespondedAudits(auditee_id);
    }

    public void branchManagerGiveResponse(BranchFinancialAudit branchFinantialAudit) {

        memorandomBranchManagerMapper.branchManagerGiveResponse(branchFinantialAudit);
    ...
    public void branchManagerGiveResponseSelcted(List<BranchFinancialAudit> branchFinantialAudits) {
        ...
        for (BranchFinancialAudit branchFinancialAudit : branchFinantialAudits) {
            ...
            memorandomBranchManagerMapper.branchManagerGiveResponse(branchFinancialAudit);
