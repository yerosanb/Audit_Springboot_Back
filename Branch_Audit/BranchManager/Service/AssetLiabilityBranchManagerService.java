...
import com.afr.fms.Branch_Audit.BranchManager.Mapper.AssetLiabilityBranchManagerMapper;
import com.afr.fms.Branch_Audit.Entity.BranchFinancialAudit;

@Service
public class AssetLiabilityBranchManagerService {

    @Autowired
    private AssetLiabilityBranchManagerMapper assetLiabilityBranchManagerMapper;

    public List<BranchFinancialAudit> getPendingAudits(Long branch_id) {
        return assetLiabilityBranchManagerMapper.getPendingAudits(branch_id);
    }

    public List<BranchFinancialAudit> getRectifiedAudits(Long auditee_id) {
        return assetLiabilityBranchManagerMapper.getRectifiedAudits(auditee_id);
    }

    public List<BranchFinancialAudit> getRespondedAudits(Long auditee_id) {
        return assetLiabilityBranchManagerMapper.getRespondedAudits(auditee_id);
    }

    public void branchManagerGiveResponse(BranchFinancialAudit branchFinantialAudit) {

        assetLiabilityBranchManagerMapper.branchManagerGiveResponse(branchFinantialAudit);
    ...
    public void branchManagerGiveResponseSelcted(List<BranchFinancialAudit> branchFinantialAudits) {
        ...
        for (BranchFinancialAudit branchFinancialAudit : branchFinantialAudits) {
            ...
            assetLiabilityBranchManagerMapper.branchManagerGiveResponse(branchFinancialAudit);
