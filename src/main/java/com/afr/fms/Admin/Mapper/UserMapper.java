...
public interface UserMapper {
        ...
        @Insert("INSERT INTO [afrfms].[dbo].[user](first_name, middle_name, last_name, email, password, phone_number, status, branch_id, photo_url, region_id, gender, emp_id, job_position_id, category, banking)"
                        + " VALUES (#{first_name},#{middle_name}, #{last_name}, #{email}, #{password}, #{phone_number},0, #{branch.id}, #{photoUrl}, #{region.id}, #{gender}, #{employee_id}, #{jobPosition.id}, #{category}, #{banking})")
