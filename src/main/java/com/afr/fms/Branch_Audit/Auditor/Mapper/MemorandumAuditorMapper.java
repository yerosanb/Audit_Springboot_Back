...
public interface MemorandumAuditorMapper {
	...
	@Update("update branch_financial_audit set fbanking = #{banking}, inding=#{finding}, impact=#{impact}, recommendation=#{recommendation}, finding_date = #{finding_date}, is_edited = 1 , finding_detail = #{finding_detail} where id=#{id}")
