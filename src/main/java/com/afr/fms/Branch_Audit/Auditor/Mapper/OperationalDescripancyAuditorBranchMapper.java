...
public interface OperationalDescripancyAuditorBranchMapper {
	...
	@Update("update branch_financial_audit set banking = #{banking}, branch_id = #{branch.id} ,finding_date = #{finding_date}, finding= #{finding} ,impact= #{impact} , recommendation=#{recommendation} , category=#{category}, save_template = #{save_template} where id = #{id}")
	...
	@Update(" update  branch_financial_audit set banking = #{banking}, branch_id = #{branch.id} ,finding_date = #{finding_date}, finding= #{finding} ,finding_detail=#{finding_detail}, impact= #{impact} , recommendation=#{recommendation} , category=#{category}, save_template = #{save_template} where id = #{id}")
