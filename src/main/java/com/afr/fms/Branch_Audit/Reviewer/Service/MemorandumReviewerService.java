...
import com.afr.fms.Branch_Audit.Reviewer.Mapper.MemorandumReviewerMapper;

@Service
public class MemorandumReviewerService {
    @Autowired
    private MemorandumReviewerMapper reviewerMapper;
