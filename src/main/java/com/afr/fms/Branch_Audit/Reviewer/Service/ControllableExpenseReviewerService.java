...
import com.afr.fms.Branch_Audit.Reviewer.Mapper.ControllableExpenseReviewerMapper;

@Service
public class ControllableExpenseReviewerService {
    @Autowired
    private ControllableExpenseReviewerMapper reviewerMapper;
