package com.afr.fms.Branch_Audit.Approver.Controller;
...
@RestController
@RequestMapping("/api/branch_audit/approver/")
@PreAuthorize("hasRole('APPROVER_BFA')")
public class ApproverBranchController {

	@Autowired
	private ApproverBranchService auditService;
	@Autowired
