...
public class ReportSqlMemorandum {

	public String getBranchMemorandumAuditReport(@Param("region_id") Long region_id, @Param("branch_id") Long branch_id,
			...
			@Param("memorandum_amount_min") Double memorandum_amount_min,
			@Param("contingent_amount_min") Double contingent_amount_min,
			@Param("memorandum_amount_max") Double memorandum_amount_max,
			@Param("contingent_amount_max") Double contingent_amount_max,
		...
		if (single_filter_info.equalsIgnoreCase("branch")) {
			sql.SELECT("	bfa.id, " + "	bfa.case_number, " + "	b.name as branch_name, "
					...
					+ "	acb.memorandom_amount as memorandum_amount, "
					+ "	acb.contingent_amount as contingent_amount, "
					...
					.JOIN("memorandom_contingent_branch AS acb ON bfa.id = acb.branch_audit_id")
			...
			System.out.println("contingent_amount_max: " + contingent_amount_max);
			System.out.println("memorandum_amount_min: " + memorandum_amount_min);

			if (memorandum_amount_min != null)
				sql.AND().WHERE("acb.memorandom_amount >= #{memorandum_amount_min} ");

			if (memorandum_amount_max != null)
				sql.AND().WHERE("acb.memorandom_amount <= #{memorandum_amount_max} ");

			if (contingent_amount_min != null)
				sql.AND().WHERE("acb.contingent_amount >= #{contingent_amount_min} ");

			if (contingent_amount_max != null)
				sql.AND().WHERE("acb.contingent_amount <= #{contingent_amount_max} ");
		}
...
//				sql.AND().WHERE("acb.account_number = #{account_number}");
		}
